...
class FingerprintClassApi(object):
    ...
    def fingerprint_class_list(self, **kwargs):  # noqa: E501
        """List Fingerprint Class objects.  # noqa: E501

        Use this method to list all Fingerprint Class objects. A fingerprint class specifies the name of a device class for use in fingerprinting  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.fingerprint_class_list(async_req=True)
        >>> result = thread.get()
        ...
        :return: LeasesListFingerprintClassResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.fingerprint_class_list_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.fingerprint_class_list_with_http_info(**kwargs)  # noqa: E501
            return data

    def fingerprint_class_list_with_http_info(self, **kwargs):  # noqa: E501
        """List Fingerprint Class objects.  # noqa: E501

        Use this method to list all Fingerprint Class objects. A fingerprint class specifies the name of a device class for use in fingerprinting  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.fingerprint_class_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['filter', 'order_by', 'fields', 'offset', 'limit', 'page_token']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method fingerprint_class_list" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='LeasesListFingerprintClassResponse',  # noqa: E501
    ...
    def fingerprint_class_read(self, id, **kwargs):  # noqa: E501
        """Read the Fingerprint Class object.  # noqa: E501

        Use this method to read a Fingerprint Class object. A fingerprint class specifies the name of a device class for use in fingerprinting  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.fingerprint_class_read(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: An application specific resource identity of a resource (required)
        :return: LeasesReadFingerprintClassResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.fingerprint_class_read_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.fingerprint_class_read_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def fingerprint_class_read_with_http_info(self, id, **kwargs):  # noqa: E501
        """Read the Fingerprint Class object.  # noqa: E501

        Use this method to read a Fingerprint Class object. A fingerprint class specifies the name of a device class for use in fingerprinting  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.fingerprint_class_read_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method fingerprint_class_read" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `fingerprint_class_read`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LeasesReadFingerprintClassResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
