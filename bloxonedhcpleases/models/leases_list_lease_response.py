...
class LeasesListLeaseResponse(object):
    ...
    def __init__(self, results=None):  # noqa: E501
        """LeasesListLeaseResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def results(self):
        """Gets the results of this LeasesListLeaseResponse.  # noqa: E501

        The list of Lease objects.  # noqa: E501

        :return: The results of this LeasesListLeaseResponse.  # noqa: E501
        :rtype: list[LeasesLease]
        """
        return self._results

    @results.setter
    def results(self, results):
        """Sets the results of this LeasesListLeaseResponse.

        The list of Lease objects.  # noqa: E501

        :param results: The results of this LeasesListLeaseResponse.  # noqa: E501
        :type: list[LeasesLease]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LeasesListLeaseResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LeasesListLeaseResponse):
            return False
